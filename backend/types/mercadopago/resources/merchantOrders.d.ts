...
export type MerchantOrderCreateResponse = MercadoPagoResponse<
  ExecOptions<DefaultConfigurationOmitQs, CreateMerchantOrderPayload>
>;

export type MerchantOrderUpdateResponse = MercadoPagoResponse<
