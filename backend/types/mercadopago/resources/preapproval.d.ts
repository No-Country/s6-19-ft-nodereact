...
export type PreApprovalCreateResponse = MercadoPagoResponse<
  ExecOptions<DefaultConfigurationOmitQs, CreatePreApprovalPayload>
>;

export type PreApprovalUpdateResponse = MercadoPagoResponse<
