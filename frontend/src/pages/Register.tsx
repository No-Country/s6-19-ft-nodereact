          ...
          <div className="bg-white md:w-2/5 w-[90%]  rounded-3xl shadow-lg py-50 border border-gray-400  mx-3 md:my-0 my-10">
            <div className=" bg-white rounded-lg p-1 m-1  ">
              <div className="flex justify-center mt-10 mb-5">
                <h1 className="md:text-[32px] text-[25px] ">Crea tu cuenta</h1>
              </div>
             
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="flex flex-col items-center justify-center gap-2 ">
                  <div className="w-3/4 mr-2">
                    <label className=" font-medium text-gray-700 mb-2 md:text-lg text-sm">
                      Nombres y apellidos
                    </label>
                    <input
                      type="text"
                  ...
                  <button
                    className="bg-purple-600 hover:bg-purple-500 text-white md:text-lg text-sm font-bold py-2 px-14 w-3/4 mb-5  rounded-xl block mt-5 drop-shadow-lg"
                    type="submit"
                  >
                    {isLoading ? (
