...
const PlanesPage = () => {
  ...
  return (
    <div className="container mx-auto border-b border-violeta-100">
      <nav className="breadcrumb my-2" aria-label="breadcrumbs">
        <ol className="flex">
          <li>
            <a href="/" className="text-blue-500 hover:text-blue-600 underline font-bold">
              Inicio
            </a>
          </li>
          <li className="mx-2">{">"}</li>
          <li>
            <a href="/#planes" className="text-blue-500 hover:text-blue-600 underline">
              planes
            </a>
          </li>
          <li className="mx-2">{">"}</li>
          <li className="text-gray-900 font-bold">Plan 3 días</li>
        </ol>
      </nav>
      <main>
        <h1 className="text-4xl my-10">Tu Plan por 3 días</h1>
        <div className="flex flex-col md:flex-row mr-40">
          <div className="w-full md:w-2/3 border border-gray-900 mr-40">
