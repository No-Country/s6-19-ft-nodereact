                ...
                {books.map((book,index)=>{
                    return (
                        <div key={index} className="flex flex-col items-center" >
                            ...
                            <button className="bg-violeta-100 hover:bg-purple-500 text-white font-medium  text-sm   rounded-[10px] block my-5 drop-shadow-lg"
                            disabled={loading}
                            type="submit"
                            >
                            {loading ?
                            ...
                            <div className="flex items-center mb-32">
                                <div className="flex">
                                    <img className="w-5 h-5" src="./assets/greenStar.png" alt="green start" />
                                    <img className="w-5 h-5" src="./assets/greenStar.png" alt="green start" />
                                    <img className="w-5 h-5" src="./assets/greenStar.png" alt="green start" />
                                    <img className="w-5 h-5" src="./assets/greenStar.png" alt="green start" />
                                    <img className="w-5 h-5" src="./assets/greenStar.png" alt="green start" />
