...
const ImageSlider = ({ slides }: Props) => {
  ...
  return (
    <div className="h-full flex relative ">
      <BsFillArrowRightCircleFill
        className="absolute top-1/2 cursor-pointer hover:opacity-80 transform -scale-x-100 left-9"
        onClick={goToPrevious}
      />

      <BsFillArrowLeftCircleFill
        className="absolute top-1/2 cursor-pointer hover:opacity-80 right-9"
        onClick={goToNext}
      />
