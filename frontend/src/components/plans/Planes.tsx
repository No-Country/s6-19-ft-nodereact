            ...
            <div className="grid grid-cols-4">
                <div className="mt-16 mx-3">
                    <div className='flex justify-end mr-10 mb-24'>
                        <img src="./src/assets/arcticons_verifit.png" alt="" />
                    </div>
                    <h1 className='text-5xl text-center font-bold mb-5'>ELEGÍ UN PLAN ACORDE A VOS</h1>
                    <h1 className='text-xl text-center font-bold mb-5'>+ 24 reviews</h1>
                    <div className='flex justify-center'>
                        <img src="./src/assets/puntitos.png" alt="" />
                    </div>
                </div>
                <div className="">
                    <div className="bg-white rounded-3xl shadow-lg p-8 border border-gray-400 h-full mx-3">
                        ...
                        <h2 className="text-center text-2xl font-medium my-5">Plan - 3 días</h2>
