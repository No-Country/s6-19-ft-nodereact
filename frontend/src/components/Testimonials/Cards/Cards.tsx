  ...
  return (
    <>
      {profilesCard.map((card) => {
        return (
          <div
            className={card.id === 2 ? "md:min-w-[306px]  md:max-w-[345px] border-2 border-[#0000004d] rounded-[20px] relative top-[60px] md:mb-0 mb-12" : " md:min-w-[306px] md:max-w-[345px] border-2 border-[#0000004d] rounded-[20px] md:top-0 relative top-[60px] md:mb-0 mb-12"}
            key={card.id}
          >
            <img
            ...
            />
            <div className="relative p-5 text-[11px] md:min-w-[306px] md:max-w-[345px]">
