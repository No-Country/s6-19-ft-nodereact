    ...
    <section className="pt-28" id="planes">
      <div className="container mx-auto  ">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 ">
          <div className="mt-16 mx-3 self-center">
          ...
          <div className="">
            <div className="bg-white rounded-3xl shadow-lg p-8 border border-gray-400 h-full mr-3">
              ...
              <Link to="/planes/2">
                <button className="bg-purple-600 hover:bg-purple-500 text-white font-medium py-2 px-14 rounded-2xl block mx-auto mt-10 drop-shadow-lg relative top-5">
                  Descargar
                </button>
              </Link>
